...
IF($ProcessTSR -ieq "y"){
 ...
 #Write-Host "*******************************************************************************"
    ...
    #Dev
    #$url = 'https://gsetools.blob.core.windows.net/drift/DriFTDEV.ps1.remove?sp=r&st=2021-10-26T15:43:17Z&se=2024-10-26T23:43:17Z&spr=https&SECRET REMOVED'
    #Prod
    $url = 'https://gsetools.blob.core.windows.net/drift/DriFT.ps1.remove?sp=r&st=2021-06-16T21:35:19Z&se=2026-06-17T05:35:19Z&spr=https&SECRET REMOVED'
